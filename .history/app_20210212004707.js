...
switch(estilo) {
    case "colorful-blue-purple":
        let file = "styles/style-colorful-blue-purple.css";
        break;
    case "dark-theme":
        let file = "styles/style-dark-theme.css";
        break;
    case "light-blue":
        let file = "styles/style-light-blue.css";
        break;
    case "light-green":
        let file = "styles/style-light-green.css";
        break;
    default:
        let file = "styles/style-default.css";
}
