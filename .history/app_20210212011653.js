...
$(function () {
    let options = {
        ...
        columnDefs:[
            ...
            { responsivePriority: 3, targets: 6, "className": "text-center" },
            { responsivePriority: 3, targets: 7, "className": "text-center" },
            { responsivePriority: 3, targets: 8, "className": "text-center" },
            { responsivePriority: 3, targets: 9, "className": "text-center" },
            { responsivePriority: 3, targets: 10, "className": "text-center" },
            { responsivePriority: 3, targets: 11, "className": "text-center" },
            { responsivePriority: 3, targets: 12, "className": "text-center" },
            { responsivePriority: 3, targets: 13, "className": "text-center" },
        ],
        "order": [[ 1, "desc" ]],
        "pageLength": 25
    }
