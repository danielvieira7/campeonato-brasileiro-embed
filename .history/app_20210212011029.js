...
$(function () {
    let options = {
        ...
        columnDefs:[
            ...
            { responsivePriority: 1, targets: 1, "className": "dt-body-nowrap" },
            { responsivePriority: 1, targets: 2, "className": "dt-body-nowrap" },
            { responsivePriority: 1, targets: 3, "className": "dt-body-nowrap" },
            { responsivePriority: 1, targets: 4, "className": "dt-body-nowrap" },
            { responsivePriority: 1, targets: 5, "className": "dt-body-nowrap" },
        ],
        "order": [[ 1, "desc" ]],
        "pageLength": 25
    }
