...
$(function () {
    let options = {
        ...
        columnDefs:[
            { responsivePriority: 1, targets: 0, "width": "2.5%", "className": "dt-body-nowrap" },
            { responsivePriority: 2, targets: 1, "className": "dt-body-nowrap" },
            { responsivePriority: 3, targets: 2, "className": "dt-body-nowrap" },
            { responsivePriority: 3, targets: 3, "className": "dt-body-nowrap" },
            { responsivePriority: 3, targets: 4, "className": "dt-body-nowrap" },
            { responsivePriority: 3, targets: 5, "className": "dt-body-nowrap" },
        ],
        "order": [[ 1, "desc" ]],
        "pageLength": 25
    }
