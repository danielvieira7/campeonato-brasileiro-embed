...
$(function () {
    ...
    var options = {
        ...
        "language": { "emptyTable": "Não há formas de contrato para esta pesquisa",
            "sInfo": "Exibindo um total de _TOTAL_ formas de contrato",
            "sInfoEmpty": "",
            "search": "Pesquisar: ",
            "infoFiltered": "",
            "sZeroRecords": "Não há formas de contrato para esta pesquisa",},
        columns: [
            {"data": "id_forma_contrato"},
            {"data": "nome"},
            {"data": "figurar_slideshow", render:formataSimNao},
